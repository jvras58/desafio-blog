...
const saveFormData: SubmitHandler<CampaignFormType> = async (values) => {
    // Garantir que o link seja uma URL completa
    const UrlCampanha = `http://suacampanha.com/${values.link}`;
    values.link = UrlCampanha;

    console.log("Sua função de salvamento personalizada");
    console.log(values);
};
...
export const forms: Form<CampaignFormType>[] = [
	...
	{ id: 3, label: "Página", form: Step3, fields: ["link"] },
];
